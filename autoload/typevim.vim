...
""
" @public
" Return the value of {setting_name}, which should be a scoped variable name
" (e.g.  `"g:foobar"`, including the leading `"g:"`), or {default}, if
" {setting_name} has no value set.
"
" This function exists so that plugins may present a familiar "legacy"
...
function! typevim#VarOrDefault(setting_name, Default, ...)
